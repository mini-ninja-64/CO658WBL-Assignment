...
//         graphDatabaseFile.write(reinterpret_cast<const char
//         *>(headerBuffer.data()), GRAPH_DATABASE_HEADER_SIZE);
//     }
//     void saveBPlusTree() {
...
//
// public:
//     explicit BipartiteGraphDatabase(const std::filesystem::path&
//     databasePath, bool forceNewFile):
//             newFile(forceNewFile || !exists(databasePath)),
//             graphDatabaseFile(databasePath, std::ios::in | std::ios::out |
//             std::ios::binary), graphDatabaseHeader(newFile ? DEFAULT_HEADER :
//             deserializeHeader(graphDatabaseFile)) {
//         if (newFile) {
//             saveHeader();
//             saveBPlusTree();
//         }
